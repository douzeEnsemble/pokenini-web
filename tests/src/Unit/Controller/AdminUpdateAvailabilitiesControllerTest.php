...
final class AdminUpdateAvailabilitiesControllerTest extends TestCase
{
    public function testUpdateAvailabilities(): void
    {
        ...
        $controller->updateAvailabilities($requestStack);
    ...
    public function testUpdateAvailabilitiesError(): void
    {
        $adminAction = new AdminAction(
            'truc',
            'machin',
    ...
    private function getController(): AdminUpdateAvailabilitiesController
    {
        ...
        return new AdminUpdateAvailabilitiesController($getActionLogsService);
    }
}
