...
class TypesTest extends WebTestCase
{
    ...
    public function testFilterPrimaryTypeFire(): void
    {
        ...
        $this->assertEquals(
            '/fr/album/demo?cs=no&t=7b52009b64fd0a2a49e6d8a939753077792b0554&t1=fire',
            $crawler->filter('table a')->first()->attr('href')
        );
        $this->assertEquals(
            '/fr/album/demo?t=7b52009b64fd0a2a49e6d8a939753077792b0554&t1=fire',
    ...
    public function testFilterSecondaryTypePoisonOrFlying(): void
    {
        ...
        $crawler = $client->request(
            'GET',
            '/fr/album/demo?t2=poison,flying&t=7b52009b64fd0a2a49e6d8a939753077792b0554'
        );
        ...
        $this->assertCountFilter($crawler, 7, 'table a');
        $this->assertEquals(
            '/fr/album/demo?cs=no&t=7b52009b64fd0a2a49e6d8a939753077792b0554&t2=poison,flying',
            $crawler->filter('table a')->first()->attr('href')
        );
        $this->assertEquals(
            '/fr/album/demo?t=7b52009b64fd0a2a49e6d8a939753077792b0554&t2=poison,flying',
            $crawler->filter('table a')->last()->attr('href')
        );
    }
    ...
    public function testFilterPrimaryTypeFightingAndSecondaryTypeFireOrWater(): void
    {
        ...
        $crawler = $client->request(
            'GET',
            '/fr/album/demo?t=7b52009b64fd0a2a49e6d8a939753077792b0554&t1=fighting&t2=fire,water',
        );
        ...
        $this->assertCountFilter($crawler, 7, 'table a');
        $this->assertEquals(
            '/fr/album/demo?cs=no&t=7b52009b64fd0a2a49e6d8a939753077792b0554&t1=fighting&t2=fire,water',
            $crawler->filter('table a')->first()->attr('href')
        );
        $this->assertEquals(
            '/fr/album/demo?t=7b52009b64fd0a2a49e6d8a939753077792b0554&t1=fighting&t2=fire,water',
    ...
    public function testFilterPrimaryTypeFightingAndSecondaryTypeNullFireOrWater(): void
    {
        ...
        $crawler = $client->request(
            'GET',
            '/fr/album/demo?t=7b52009b64fd0a2a49e6d8a939753077792b0554&t1=fighting&t2=null,fire,water',
        );
        ...
        $this->assertCountFilter($crawler, 7, 'table a');
        $this->assertEquals(
            '/fr/album/demo?cs=no&t=7b52009b64fd0a2a49e6d8a939753077792b0554&t1=fighting&t2=null,fire,water',
            $crawler->filter('table a')->first()->attr('href')
        );
        $this->assertEquals(
            '/fr/album/demo?t=7b52009b64fd0a2a49e6d8a939753077792b0554&t1=fighting&t2=null,fire,water',
    ...
    public function testFilterTypeUnknown(): void
    {
        ...
        $this->assertCountFilter($crawler, 7, 'table a');
        $this->assertEquals(
            '/fr/album/demo?cs=no&t=7b52009b64fd0a2a49e6d8a939753077792b0554&t1=unknown',
            $crawler->filter('table a')->first()->attr('href')
        );
        $this->assertEquals(
            '/fr/album/demo?t=7b52009b64fd0a2a49e6d8a939753077792b0554&t1=unknown',
            $crawler->filter('table a')->last()->attr('href')
        );
    }
}
